      ...
      <div className="max-w-7xl mx-auto">
        <div className="max-w-[480px] md:max-w-3xl mx-auto">
            ...
            <form className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                 ...
                 <div className="space-y-2">
                   ...
                   <select className="w-full bg-stone-50 border border-stone-100 rounded-xl px-4 py-4 text-sm focus:ring-2 focus:ring-[#8B5E3C] outline-none transition-all">
          ...
          <div className="mt-24 md:mt-32 text-center pb-12">
             <span className="text-[#8B5E3C] text-5xl md:text-7xl font-accent block mb-6 italic drop-shadow-sm">Matur Suksma</span>
             <p className="text-[10px] md:text-xs text-stone-400 tracking-[0.4em] uppercase font-bold">Dewax & Chika • 2026</p>
          </div>
        </div>
      </div>
    </section>
